...
export const LAUNCHPAD_PROGRAM_ID = new PublicKey('JejuLauncher1111111111111111111111111111111');
...
export class JejuLaunchpadClient {
...
export function createLaunchpadClient(
  ...
  return new JejuLaunchpadClient(connection, programId);
}
