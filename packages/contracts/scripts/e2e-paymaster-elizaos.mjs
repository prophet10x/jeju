...
const ENTRYPOINT = process.env.ENTRYPOINT || '0x3eb934d56d14fa073ef859c13a7ab9c5f8eeb948'
const PAYMASTER = process.env.PAYMASTER || '0xA539885c451072af0BcA62f570B8AD296823830A'
const ELIZAOS_TOKEN = process.env.ELIZAOS_TOKEN || '0x8332E76E40805aC9B06f3B11c1F415D608F66Db3'
const FACTORY = process.env.FACTORY || '0x58A55Dc97a3bBA3CD16d927e3Ed5b3c90F8E1A4c'
